...
class User(models.Model):
    ...
    reviewed_books = models.ManyToManyField('Book', related_name='user_who_reviewed')
...
class Book(models.Model):
    ...
    review = models.TextField(default='default desc')
    rating = models.IntegerField()
    #user_who_reviewed = models.ManyToManyField('User', related_name='reviewed_books')
