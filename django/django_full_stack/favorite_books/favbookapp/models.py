    ...
    def add_book_validator(self, post_data):
        ...
        if len(post_data['desc']) != 0:
            if len(post_data['desc']) < 10:
                errors['desc_not_zero'] = "Description must be at least 10 characters."
...
class User(models.Model):
    ...
    #books_uploaded object
    liked_books = models.ManyToManyField('Book', related_name='users_who_liked')
    #validation objects
    objects = UserManager()
